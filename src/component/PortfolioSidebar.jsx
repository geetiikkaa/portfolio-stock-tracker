...
export default function PortfolioSidebar() {
    ...
    return (
        <>
            <aside className="w-60 h-screen shrink-0 border-r border-white/10 bg-[#0d0d18] flex flex-col py-6 px-4">
                ...
                <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-400 hover:bg-white/5 hover:text-gray-200 transition">
                    <LogOut size={17} />
                    Logout
                </button>
            </aside>
